...
<div style="background-color: gray;" id="con" class="col-md-12">
	<div class="container" >
	   <div class="row"> 
				...
				<?php }  ?>
				<h2 style="color: white; padding: 10px; background-color: green; text-align: center;" >Student List</h2>
				<div class="std">
							...
							<tr>
								...
								<td><?php echo $mydata['name']?></td>
									...
									<td style="text-align: center;">
										...
										<a  class="btn btn-warning" href="edit.php? id=<?php echo $mydata["id"];?>" id="action"> Edit</a>
